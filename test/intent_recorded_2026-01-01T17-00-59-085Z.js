/**
 * Auto-recorded Test: recorded_2026-01-01T17-00-59-085Z
 * Generated: 2026-01-01T17:00:59.085Z
...
async function runMission() {
    ...
    try {
        ...
        console.log('[Mission] Starting recorded test: recorded_2026-01-01T17-00-59-085Z');
    ...
    await runner.clickGoal('Blog', { stabilityHint: 2026 });
    console.log('[Mission] Step 4: Navigating to https://www.dhirajdas.dev/blog/starlight-mission-control-observability-roi...');
    await runner.goto('https://www.dhirajdas.dev/blog/starlight-mission-control-observability-roi');

    await runner.clickGoal('h3', { stabilityHint: 2040 });
    await runner.clickGoal('blog-title');
